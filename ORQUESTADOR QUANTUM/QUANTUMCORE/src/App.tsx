...
import { SeccionMemoriaYOrganizacion } from './componentes/memoria/SeccionMemoriaYOrganizacion';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    fetchTasks();
    fetchMemories();
  }, [fetchAgents, fetchProjects, fetchIdeas, fetchTasks, fetchMemories]);
    ...
    <BrowserRouter>
      <TourProvider>
        ...
        <Layout>
          ...
          <Route path="/memory" element={<SeccionMemoriaYOrganizacion />} />
