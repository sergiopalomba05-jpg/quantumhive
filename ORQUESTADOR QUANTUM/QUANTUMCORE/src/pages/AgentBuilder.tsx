...
export function AgentBuilder() {
  ...
  const handleSave = () => {
    ...
    useStore.setState(state => ({
      ...
      workflowDefinitions: [createStarterAgentWorkflow(newAgent.id, newAgent.name), ...state.workflowDefinitions],
    }));
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-8 relative">
      ...
      <div className="absolute inset-x-0 top-0 h-64 rounded-2xl overflow-hidden opacity-30 pointer-events-none">
        <img src="/brand/curated/bg-agent-builder.jpeg" alt="" className="w-full h-full object-cover" />
