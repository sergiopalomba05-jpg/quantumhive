...
export const GCP_VERTEX_MODELS: ProviderModelDefinition[] = [
  {
    ...
    notes: 'Último modelo Stable. Balance velocidad/inteligencia. Reemplaza a 2.5 Flash como default.',
  },
  {
    id: 'gemini-3.5-flash',
    ...
    notes: 'Modelo más inteligente para agentic y coding tasks. Stable.',
  },
  {
    id: 'gemini-2.5-flash',
