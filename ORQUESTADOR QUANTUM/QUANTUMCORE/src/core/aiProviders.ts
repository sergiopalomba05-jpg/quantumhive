...
export const GCP_VERTEX_MODELS: ProviderModelDefinition[] = [
  {
    ...
    routerReady: false,
    capabilities: ['text', 'multimodal', 'fast', 'grounding', 'agentic'],
    notes: 'Candidato futuro. Vertex respondio que no esta disponible en us-central1 para este proyecto.',
  },
  {
    id: 'gemini-3.5-flash',
    ...
    connectionStatus: 'candidate',
    routerReady: false,
    capabilities: ['text', 'multimodal', 'reasoning', 'code', 'agentic'],
    notes: 'Candidato futuro. No usar como router default hasta validar disponibilidad real en Vertex.',
  },
  {
    id: 'gemini-2.5-flash',
    ...
    notes: 'Legacy. Se retira Octubre 2026. Migrar a 3.6 Flash.',
  },
  {
    id: 'gemini-2.5-pro',
    ...
    notes: 'Legacy. Se retira Octubre 2026. Sintetizador de V.S 2 Cerebros.',
  },
  {
    ...
    notes: 'Modelo liviano Stable para tareas masivas y clasificación.',
  },
  {
    ...
    connectionStatus: 'candidate',
    routerReady: false,
    capabilities: ['text', 'reasoning', 'code', 'preview'],
    notes: 'Preview del modelo Pro más avanzado. 1M tokens context. Pendiente de validación.',
  },
  {
    ...
    notes: 'Live API A2A最新preview para diálogo realtime y voz.',
  },
  {
