...
export const helpArticles: HelpArticle[] = [
  ...
  {
    id: 'contextual-assistants',
    title: 'Cómo usar los Asistentes Contextuales',
    content: '## ¿Qué son los Asistentes Contextuales?\nCada sección de la aplicación cuenta con un Asistente IA especializado que te guiará paso a paso.\n\n## ¿Cuándo usarlos?\nUtilízalos cuando no sepas cómo configurar una funcionalidad (por ejemplo, crear un agente, conectar una base de datos) o cuando quieras automatizar la creación de elementos base en una sección.\n\n## ¿Cómo pedir ayuda?\nBusca el botón "Asistente" en la barra superior y cuéntale qué quieres lograr en lenguaje natural.\n\n## Diferencia entre Explicación y Creación Automática\nPuedes pedirle que te explique los conceptos primero ("Explicame primero") o que genere configuraciones de ejemplo directamente en la app ("Crear automáticamente en modo simulado").\n\n## ¿Qué acciones requieren aprobación?\nAcciones de alto riesgo (como editar código, acceder a bases de datos en la nube o modificar repositorios) requerirán que las apruebes manualmente desde la Cola de Aprobación.\n\n## ¿Qué está simulado y qué será real?\nEn este MVP, la mayoría de los asistentes generarán mocks de datos (como workers, bases de datos y configuraciones). En el futuro, estas acciones se conectarán a backends reales de Google Cloud, GitHub, y LLMs.',
    tags: ['assistants', 'ai', 'help']
  }
];
